...
description: 'A comprehensive styleguide to preview all markdown and MDX-rendered elements and custom Tina components.'
---
...
Below are examples of custom Tina components used in posts.

<Figure
  src="/images/20191123_112755.jpg"
  alt="Roasted chicken on cast iron"
  caption="Figure component with caption"
  className="my-6"
/>

<YouTube id="dQw4w9WgXcQ" title="YouTube embed example" start={42} className="my-6" />
...
<Tweet id="20" theme="light" lang="en" height={320} className="my-6" />
