...
summary: A few issues that I have encountered while using applications and/or services from Microsoft
featuredPost: false
...
<blockquote className="twitter-tweet">
  <p lang="en" dir="ltr">
    Dear <a href="https://twitter.com/Microsoft?ref_src=twsrc%5Etfw">@Microsoft</a>, <br />
    <br />
    Cc <a href="https://twitter.com/Outlook?ref_src=twsrc%5Etfw">@Outlook</a>
    <br />
    <br />
    If you can make Cortana read (Play My Emails) emails. I&#39;m sure you can build a better
    spam/junk filter.
    <br />
    <br />
    Thanks, <a href="https://twitter.com/dickwyn?ref_src=twsrc%5Etfw">@dickwyn</a>{' '}
    <a href="https://t.co/S8uGdbuRCB">pic.twitter.com/S8uGdbuRCB</a>
  </p>
  &mdash; Dick Wyn Yong (@dickwyn){' '}
  <a href="https://twitter.com/dickwyn/status/1191477590323650560?ref_src=twsrc%5Etfw">
    November 4, 2019
  </a>
</blockquote>
